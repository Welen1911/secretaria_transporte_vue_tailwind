      ...
      <table class="w-full table-auto">
        <thead>
          <tr class="bg-gray-2 text-left dark:bg-meta-4">
            ...
            <th class="min-w-[120px] py-4 px-4 font-medium text-black dark:text-white">Placa</th>
            <th class="py-4 px-4 font-medium text-black dark:text-white">Capacidade</th>
        ...
        <tbody>
          <tr v-for="item in data" :key="item.id">
            ...
            <td class="py-5 px-4">
              <p class="text-black dark:text-white">{{ item.year }}</p>
            </td>
            <td class="py-5 px-4">
